...
## Full Code
This completes our step by step guide of how to use Simvue to monitor your scripts in real time. Now that our script is complete, we can remove the 'WIP' tag from the `run.init()` method! The full code is shown below:
```  py
import random
import time
import numpy
